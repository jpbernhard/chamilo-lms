...
//         $Courses_code = $a_courses ['course_code'] ;
...
//on compte le nombre de m% dans l'agenda pour chaque module
     $sqljtot =  "SELECT COUNT( * ) AS TOT
                                 ...
                                 ";
                    $resultjt = api_sql_query($sqljtot);
...
$sql4 = "SELECT *  FROM $tbl_personal_agenda
 ...
 if ($diff >0) $sing= get_lang('retard') ; 
  else $sing = get_lang('avance') ;
  $diff=abs($diff);
...
$sqlgo = "SELECT *  FROM $tbl_personal_agenda
     ...
     $result7 = api_sql_query($sqlgo,__FILE__,__LINE__);
...
//on récupere les points de controle de l'élève  
 ...
 $pt[]= '0';
  $sqlcontrole = "SELECT diff
                                 ...
                                 ";
                    $result = api_sql_query($sqlcontrole);
...
?> 
  ...
  <tr><th align="left"width="412"> 
  <?php echo get_lang('Cumulatif_agenda'); ?>: <b><font color=#CC0000> <?php echo $jour_realise_tot ?></font></b></p>
  </tr></th>
   <tr><th align="left">
   <?php echo get_lang('Cumulatif'); ?> <b><font color=#CC0000> <?php echo $Total ?></font></b></p>
   </tr></th>
    <tr><th align="left"> 
  <?php echo get_lang('jours_selon_horaire'); ?>: <b><font color=#CC0000> <?php echo  $jour_agenda?>  <?php echo $Days ?></font></b></p>
    </tr></th>
  <tr><th align="left">
  <?php echo get_lang('dif2'); ?>: <b><font color=#CC0000> <?php echo  $diff?>  <?php echo $Days,$sing ?></font></b></p></tr></th>
   <tr><th align="left">
  <?php echo get_lang('date_fin'); ?>: <b><font color=#CC0000> <?php echo  $end_date?></font></b></p></tr></th>
...
// interventions et commentaires en 3 niveaux 
?>
...
<tr>
                    <th colspan="6" >
<?php echo get_lang('create_interventions_commentaires'); echo $user_info['complete_name'];?>
                </th> 
          <tr>
                  <th>
                        <?php echo get_lang('level') ?>
                    </th>
                    <th>
                        <?php echo get_lang('lang_date') ?>
                    </th>
                    <th>
                        <?php echo get_lang('consignes_interventions') ?>
                    </th>
                    <th>
    ...
    <td>
     <input type="text" style="width:50%;" name="date" value= "<?php echo date("Y-m-d") ?>"
    </td>
...
$tbl_stats_exercices = Database :: get_main_table(TABLE_STATISTIC_TRACK_E_EXERCISES);
 ...
 $sqlinter = "SELECT *
    ...
    <td class="highlight"><a href="edit_intervention.php?num=<?php echo $exe_id ?>&student_id=<?php echo $student_id ?> "><img src="../img/edit.gif" border="0" alt="<?php echo $lang_editer ;?>"></a>
    &nbsp;&nbsp;<a href="delete_exam.php?num=<?php echo $exe_id ?>&student_id=<?php echo $student_id ?>"><img src="../img/delete.gif" border="0" alt="<?php echo $lang_suprimer ;?>" onClick='return confirmDelete2()'></a>
...
<?php   
    ...
    if (empty($_GET['details'])) {
        ...
        foreach ($courses_in_session as $key => $courses) {
            ...
            $title = '';
            if (empty($session_id)) {
        $title = Display::return_icon('course.png', get_lang('Course'), array(), ICON_SIZE_SMALL).' '.get_lang('Course');
            } else {
                $title = Display::return_icon('session.png', get_lang('Session'), array(), ICON_SIZE_SMALL).' '.$session_name.($date_session?' ('.$date_session.')':'');
            }
...
<tr>
                    <th colspan="6">
<?php echo get_lang('create_exam_title'); echo $user_info['complete_name'];?>
                    </th>

  <tr>
                <th style="width: 60px"> 
                        <?php echo get_lang('module_no') ?> 
    </th>
...
<td><input type="SUBMIT" value="Sauvegarder" name="create_exam"></td>
</tr>
    </table>
   </form>
...
<tr>
                    <th colspan="6">
<?php echo get_lang('result_exam_title'); echo $user_info['complete_name']; ?>
...
$sqlexam = "SELECT *
         ...
         $student_id= $_GET['student'] ;
                ...
                <td class="highlight">&nbsp;<a href="edit_exam.php?num=<?php echo $exe_idd ?>& student_id=<?php echo $student_id ?>"><img src="../img/edit.gif" border="0" alt="<?php echo $lang_editer ;?>"></a>
                        &nbsp;&nbsp;<a href="delete_exam.php?num=<?php echo $exe_idd ?>& student_id=<?php echo $student_id ?>"><img src="../img/delete.gif" border="0" alt="<?php echo $lang_suprimer ;?>" onClick='return confirmDelete2()'></a>
...
<strong><?php echo get_lang('imprime_sommaire');?> </strong>
    ...
    <?php   echo '<a target="_blank" href="../mySpace/print_myStudents.php?student='.$student_id.'&details=true&course='.$course_code.'&origin=tracking_course &config='.$recherche.'"><img src="'.api_get_path(WEB_IMG_PATH).'printmgr.gif" border="0" /></a>';
...
<tr>
                    <th colspan="6">
<?php echo get_lang('fin_mod_prevue'); echo $user_info['complete_name'];?>
                    </th>
