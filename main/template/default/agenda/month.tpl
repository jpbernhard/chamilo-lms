...
$(document).ready(function() {
    ...
    if(sessionStorage["currentView"] === 'undefined') 
{
sessionStorage.removeItem("currentView");
}
if(sessionStorage["currentDate"] != 'undefined')
{
 SavedDate = new moment(sessionStorage["currentDate"]);
} 
    ...
    var calendar = $('#calendar').fullCalendar({
        ...
        defaultView: sessionStorage["currentView"] || '{{ default_view }}',
	defaultDate: SavedDate || moment(),
        ...
        select: function(start, end, jsEvent, view) {
            var start_date = start.format("YY-MM-DD HH:mm");
            var end_date = end.format("YY-MM-DD HH:mm");
        ...
        eventClick: function(calEvent, jsEvent, view) {
            ...
            var start_date = calEvent.start.format("YY-MM-DD HH:mm");
            ...
            if (calEvent.allDay == 1) {
                ...
                if (calEvent.end && calEvent.end != '') {
                    var end_date  = calEvent.end.format("YY-MM-DD HH:mm");
                }
            }
            ...
            if (calEvent.editable) {
                ...
                $('#start_date').html(calEvent.start.format("YY-MM-DD HH:mm"));
                if (calEvent.end) {
                    $('#end_date').html(' - '+calEvent.end.format("YY-MM-DD HH:mm"));
                }
                ...
                // Simple form
                $('#simple_start_date').html(calEvent.start.format("YY-MM-DD HH:mm"));

                if (end_date != '') {
                    $('#simple_start_date').html(calEvent.start.format("YY-MM-DD HH:mm"));
                    $('#simple_end_date').html(' ' + calEvent.end.format("YY-MM-DD HH:mm"));
                }
                if (calEvent.course_name) {
...
/*                    minute_delta: delta.minutes()*/
                    minute_delta: delta._milliseconds/60000
                }
            });
        },
